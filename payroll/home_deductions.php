            ...
            <li>
              ...
              <form class="form-horizontal" action="#" name="form">
                <div class="form-group">
                  <label class="col-sm-5 control-label">NHIF  :</label>
                  <div class="col-sm-4">
                    <?php echo $NHIF; ?>.00
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-5 control-label">NSSF :</label>
                  <div class="col-sm-4">
                    <?php echo $NSSF; ?>.00
                  </div>
                </div>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body" style="padding:40px 50px;">
              ...
              <form class="form-horizontal" action="add_deductions.php" name="form" method="post">
                <div class="form-group">
                  <label class="col-sm-4 control-label">NHIF</label>
                  <div class="col-sm-8">
                    <input type="text" name="NHIF" class="form-control" required="required" value="<?php echo $NHIF; ?>">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-4 control-label">NSSF</label>
                  <div class="col-sm-8">
                    <input type="text" name="NSSF" class="form-control" value="<?php echo $NSSF; ?>" required="required">
                  </div>
                </div>
                <div class="form-group">
